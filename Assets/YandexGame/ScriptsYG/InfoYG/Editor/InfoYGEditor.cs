...
namespace YG.Insides
{
    ...
    public class InfoYGEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if (GUILayout.Button("ActivateCurrentLevel Newtonsoft for AUTO_LOCALIZATION"))
                {
            ...
            {
                if (GUILayout.Button("ActivateCurrentLevel Newtonsoft for SAVES_DATA"))
                {
                    if (!PackageDownloader.IsPackageImported(newtonsoftUrl))
                    {
                        if (!PackageDownloader.DownloadPackage(newtonsoftUrl))
            ...
            {
                if (GUILayout.Button("ActivateCurrentLevel TEXT_MESH_PRO"))
                {
